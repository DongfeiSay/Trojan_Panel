...
EOF
	...
	wget https://raw.githubusercontent.com/DongfeiSay/Trojan_Panel/master/.env
	...
	wget -P /etc/nginx/sites-available https://raw.githubusercontent.com/DongfeiSay/Trojan_Panel/master/default
	...
	wget -P /etc/nginx https://raw.githubusercontent.com/DongfeiSay/Trojan_Panel/master/nginx.conf
